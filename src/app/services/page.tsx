    ...
    <main className="min-h-screen bg-slate-50/50 font-sans flex flex-col justify-between">
      ...
      <header className="sticky top-0 z-50 w-full border-b border-slate-100 bg-white/80 backdrop-blur-md">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4 sm:px-8 lg:px-12">
          ...
          <nav className="hidden md:flex items-center gap-8 text-sm font-semibold text-slate-600">
            <Link href="/services" className="hover:text-[#0b335c] transition-colors text-[#0b335c]">Services</Link>
      ...
      <section className="relative h-[380px] bg-[#0b335c] overflow-hidden flex items-center">
        ...
        <div className="relative max-w-7xl mx-auto px-6 lg:px-8 z-10 text-white space-y-5 w-full">
          <span className="inline-block bg-[#0ea5e9] text-white text-[10px] font-extrabold tracking-wider px-3.5 py-1 rounded-full uppercase">
          ...
          <div className="flex flex-wrap items-center gap-4 pt-2">
            <Link 
              href="/signup" 
              className="bg-[#005c53] hover:bg-[#004d45] text-white font-bold text-xs sm:text-sm px-6 py-3.5 rounded-xl shadow-md transition-all flex items-center gap-2"
            >
            ...
            <a 
              href="#departments" 
              className="border border-white/60 hover:bg-white/10 text-white font-bold text-xs sm:text-sm px-6 py-3.5 rounded-xl transition-all"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-white border border-slate-200/60 rounded-3xl overflow-hidden shadow-sm hover:shadow-md transition-all duration-200 md:col-span-2 flex flex-col md:flex-row justify-between group">
            <div className="p-6 md:p-8 space-y-4 flex-1 flex flex-col justify-between md:max-w-[55%]">
              ...
              <Link 
                href="/signup" 
                className="bg-[#0b335c] hover:bg-[#061e38] text-white font-bold text-xs sm:text-sm px-6 py-3.5 rounded-xl transition-colors cursor-pointer w-fit shadow-sm mt-4 flex items-center gap-2"
              >
      ...
      <section className="max-w-7xl mx-auto px-6 lg:px-8 py-12 w-full">
        <div className="bg-[#0b335c] rounded-3xl p-12 text-center text-white space-y-6 relative overflow-hidden shadow-lg">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 relative z-10 pt-2">
            <Link 
              href="/signup" 
              className="bg-[#005c53] hover:bg-[#004d45] text-white font-bold text-xs sm:text-sm px-7 py-3.5 rounded-xl shadow-md transition-colors"
            >
              Get Started
            </Link>
            <Link 
              href="#" 
              className="border border-white/40 hover:bg-white/10 text-white font-bold text-xs sm:text-sm px-7 py-3.5 rounded-xl transition-colors"
            >
              Contact Support
            </Link>
          </div>
      ...
      {/* Footer */}
      <footer className="bg-slate-100/60 border-t border-slate-200/40 mt-16 pt-16 pb-8 w-full">
