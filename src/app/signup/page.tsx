        ...
        <div className="space-y-8">
          ...
          <div className="space-y-2">
            ...
            <p className="text-sm font-semibold text-slate-400">
              Register as a patient or medical professional to get started.
            </p>
          </div>
          ...
          <div className="text-center text-sm font-semibold text-slate-400 pt-4">
            ...
            <Link href="/login" className="font-bold text-[#008b7e] hover:text-[#005c53] hover:underline transition-colors">
              Sign In
            </Link>
          </div>
        </div>
